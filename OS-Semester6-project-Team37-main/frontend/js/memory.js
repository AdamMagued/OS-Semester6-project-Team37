...
var Memory = (function() {
  ...
  function _buildCell(word) {
    ...
    /* Variable name — truncated to 10 chars; full name visible in tooltip */
    var nameEl = document.createElement('div');
    nameEl.className   = 'mem-varname';
    nameEl.textContent = _trunc(varName, 10);

    /* Value (truncated) */
    var valEl = document.createElement('div');
    valEl.className   = 'mem-value';
    valEl.textContent = isEmpty ? '\u2014' : _trunc(value, 9);
